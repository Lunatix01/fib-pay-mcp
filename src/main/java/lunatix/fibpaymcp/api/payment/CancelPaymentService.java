...
public class CancelPaymentService {
    ...
    public CancelPaymentService(RestClient authroizedFibRestClient) {
        this.authroizedFibRestClient = authroizedFibRestClient;
    }

    public Void execute(CancelPaymentRequest request) {
        return authroizedFibRestClient.post()
                .uri(String.format(PaymentEndpoint.CANCEL_PAYMENT.getPaymentUrlPath(), request.paymentId))
                .body(request)
